...
export default function WhatsAppFloat() {
  ...
  const number = (get('contact_whatsapp', 'es') || '573001234567').replace(/\D/g, '');
  const message = get('whatsapp_message', 'es') || 'Hola, me interesa información sobre los tours de Colombia';
